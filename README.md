...
- `docs/assets/seasnake-type-system.css` - reusable SEASNAKE font stacks, responsive H1-H5 scale, body, lead, caption, data tokens, and Logo-derived brand-title grammar.
...
- The brand manual includes a complete `字体系统` chapter with the `VENOM + SERPENT` display direction; its screen scale and reusable CSS tokens live in `docs/assets/seasnake-type-system.css`.
